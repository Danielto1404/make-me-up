...
class MakeupOptions:
    def __init__(self):
        ...
        self.parser.add_argument('--result_dir', type=str, default='./results',
                                 help='path for saving result images and clip_trainer')
        ...
        self.parser.add_argument('--model_save_freq', type=int, default=100, help='freq (epoch) of saving clip_trainer')
        ...
        self.parser.add_argument('--resume',
                                 ...
                                 help='specified the dir of saved clip_trainer for resume the training')
        self.parser.add_argument('--num_residual_block', type=int, default=4, help='num_residual_block')
        self.parser.add_argument('--lr', type=float, default=0.0002, help='lr')
        self.parser.add_argument('--device', type=str, default=0, help='e.g cuda:0')
